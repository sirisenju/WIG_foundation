      ...
      >
        <div className="overflow-clip text-white">
          <Hamburger 
            ...
            />
            {isOpen && (
              <div className="fixed z-10 hamburger-style h-full bg-primary_theme w-[70%] top-0 right-0 p-4 overflow-clip" data-aos="slide-down">
                ...
                <div className="gap-2 flex justify-between flex-wrap max-w-xs">
                <Link to={"/login"}>
